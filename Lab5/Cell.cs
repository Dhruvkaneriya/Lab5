...
namespace Lab5.ModelComponents
{
	...
	public class Cell : Rectangle
	{
		...
		public void SetEmitSurface(SurfaceLocation location, Cell cell, double temp)
		{
			// Thanks Josh
			surfaces[(int)location] = new EmitSurface(location, cell, temp);
		}
		...
		public double EmitEnergy(double tEq, double simTime)
		{
			...
			foreach (ISurface surface in surfaces)
			{
				...
				{
					energy += emitSurface.GetEmitEnergy(tEq, simTime, Width);
				}
			}
			return energy;
		}
